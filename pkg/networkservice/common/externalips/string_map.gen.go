// Code generated by "-output string_map.gen.go -type stringMap<string,string> -output string_map.gen.go -type stringMap<string,string>"; DO NOT EDIT.
// Install -output string_map.gen.go -type stringMap<string,string> by "go get -u github.com/searKing/golang/tools/-output string_map.gen.go -type stringMap<string,string>"
