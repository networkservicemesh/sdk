...
//                  mechanismCheck - function to check that any parameters the server should have added to the
//                                   Request.Connection.Mechanism before calling the next chain element where added
