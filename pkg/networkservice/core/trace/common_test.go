...
func TestTraceOutput(t *testing.T) {
	...
	expectedOutput :=
		"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(1) ⎆ sdk/pkg/networkservice/core/trace_test/labelChangerFirstServer.Request()\n" +
			...
			"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(2)  ⎆ sdk/pkg/networkservice/core/trace_test/labelChangerSecondServer.Request()\n" +
			...
			"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(1) ⎆ sdk/pkg/networkservice/core/trace_test/labelChangerFirstServer.Close()\n" +
			...
			"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(2)  ⎆ sdk/pkg/networkservice/core/trace_test/labelChangerSecondServer.Close()\n" +
...
func TestErrorOutput(t *testing.T) {
	...
	expectedOutput :=
		"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(1) ⎆ sdk/pkg/networkservice/core/trace_test/labelChangerFirstServer.Request()\n" +
			...
			"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(2)  ⎆ sdk/pkg/networkservice/core/trace_test/labelChangerSecondServer.Request()\n" +
			"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(2.1)    request-diff={\"connection\":{\"labels\":{\"Label\":\"B\"}}}\n" +
			"\x1b[37m [TRAC] [id:conn-1] [type:networkService] \x1b[0m(3)   ⎆ sdk/pkg/networkservice/core/trace_test/errorServer.Request()\n" +
