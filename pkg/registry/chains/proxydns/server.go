...
func NewServer(ctx context.Context, proxyNSMgrURL *url.URL, options ...Option) registry.Registry {
	...
	var dnsresolveOptions []dnsresolve.Option
	if opts.dnsResolver != nil {
		dnsresolveOptions = append(dnsresolveOptions, dnsresolve.WithResolver(opts.dnsResolver))
	}

	nseChain := chain.NewNetworkServiceEndpointRegistryServer(
		dnsresolve.NewNetworkServiceEndpointRegistryServer(dnsresolveOptions...),
	...
	nsChain := chain.NewNetworkServiceRegistryServer(
		dnsresolve.NewNetworkServiceRegistryServer(dnsresolveOptions...),
