...
var _nil_NetworkServiceSyncMap_registry_NetworkService_value = func() (val *registry.NetworkService) { return }()
...
func (m *NetworkServiceSyncMap) Load(key string) (*registry.NetworkService, bool) {
	...
	if value == nil {
		return _nil_NetworkServiceSyncMap_registry_NetworkService_value, ok
	}
...
func (m *NetworkServiceSyncMap) LoadOrStore(key string, value *registry.NetworkService) (*registry.NetworkService, bool) {
	...
	if actual == nil {
		return _nil_NetworkServiceSyncMap_registry_NetworkService_value, loaded
	}
