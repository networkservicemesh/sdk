...
//go:generate go-syncmap -output ns_sync_map.gen.go -type nsClientMap<string,*nsCacheEntry>
//go:generate go-syncmap -output nse_sync_map.gen.go -type nseClientMap<string,*nseCacheEntry>
