...
// Install -output cache_entry_map.gen.go -type cacheEntryMap<string,*cacheEntry> by "go get -u github.com/searKing/golang/tools/-output cache_entry_map.gen.go -type cacheEntryMap<string,*cacheEntry>"
