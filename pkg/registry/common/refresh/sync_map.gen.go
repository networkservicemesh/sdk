...
// Install -output sync_map.gen.go -type cancelsMap<string,context.CancelFunc> by "go get -u github.com/searKing/golang/tools/-output sync_map.gen.go -type cancelsMap<string,context.CancelFunc>"
