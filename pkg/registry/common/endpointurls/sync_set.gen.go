// Code generated by "-output sync_set.gen.go -type Set<net/url.URL,struct{}> -output sync_set.gen.go -type Set<net/url.URL,struct{}>"; DO NOT EDIT.
...
func (m *Set) LoadAndDelete(key url.URL) (value struct{}, loaded bool) {
