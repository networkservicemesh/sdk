...
// Install -output nse_server_map.gen.go -type nseServerMap<string,*eventNSEFactoryServer> by "go get -u github.com/searKing/golang/tools/-output nse_server_map.gen.go -type nseServerMap<string,*eventNSEFactoryServer>"
