...
// Install -output map.gen.go -type stringCCMap<string,google.golang.org/grpc.ClientConnInterface> by "go get -u github.com/searKing/golang/tools/-output map.gen.go -type stringCCMap<string,google.golang.org/grpc.ClientConnInterface>"
