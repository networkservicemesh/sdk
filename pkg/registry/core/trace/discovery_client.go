...
// NewDiscoveryClient - wraps registry.NetworkServiceDiscoveryClient with tracing
func NewDiscoveryClient(traced registry.NetworkServiceDiscoveryClient) registry.NetworkServiceDiscoveryClient {
