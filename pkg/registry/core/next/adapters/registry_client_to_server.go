...
func NewRegistryClientToServer(client registry.NetworkServiceRegistryClient, next func(ctx context.Context) registry.NetworkServiceRegistryServer) registry.NetworkServiceRegistryServer {
