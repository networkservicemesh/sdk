...
func NewRegistryServerToClient(server registry.NetworkServiceRegistryServer, next func(ctx context.Context) registry.NetworkServiceRegistryClient) registry.NetworkServiceRegistryClient {
