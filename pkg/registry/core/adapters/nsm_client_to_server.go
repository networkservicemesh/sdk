...
func NewNSMClientToServer(client registry.NsmRegistryClient) registry.NsmRegistryServer {
	return NewNSMClientToServerNext(client, nil)
}
...
// NewNSMClientToServerNext - returns a registry.NsmRegistryServer wrapped around the supplied client
func NewNSMClientToServerNext(client registry.NsmRegistryClient, next func(ctx context.Context) registry.NsmRegistryServer) registry.NsmRegistryServer {
