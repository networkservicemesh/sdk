...
var _nil_timerMap_timer_value = func() (val *timer) { return }()
...
func (m *timerMap) Load(key string) (*timer, bool) {
	...
	if value == nil {
		return _nil_timerMap_timer_value, ok
	}
...
func (m *timerMap) LoadOrStore(key string, value *timer) (*timer, bool) {
	...
	if actual == nil {
		return _nil_timerMap_timer_value, loaded
	}
...
func (m *timerMap) LoadAndDelete(key string) (value *timer, loaded bool) {
